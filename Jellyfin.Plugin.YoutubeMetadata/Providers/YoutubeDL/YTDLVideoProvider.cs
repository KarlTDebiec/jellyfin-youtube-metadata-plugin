...
{
    public class YTDLVideoProvider : AbstractYoutubeRemoteProvider<YTDLVideoProvider, Video, VideoInfo>
    {
        ...
        internal override MetadataResult<Video> GetMetadataImpl(YTDLData jsonObj, string id) => Utils.YTDLJsonToVideo(jsonObj);
